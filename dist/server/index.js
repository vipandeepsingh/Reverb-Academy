globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-W4nOksuZ.js","assets/layout-segment-context-_mcTP5c2.js"];
...
function getDraftSecret() {
	return "d98b43a8-4b70-4436-aced-49fe96381ed0";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "aba271b5-00d3-4a07-a722-c83a8fb705a4";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "aba271b5-00d3-4a07-a722-c83a8fb705a4") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "aba271b5-00d3-4a07-a722-c83a8fb705a4",
		rootBoundaryId
	});
}
/**
...
var siteUrl = "https://reverbacademy.com";
var metadata = {
	...
	openGraph: {
		...
		locale: "en_IN",
		url: siteUrl,
		siteName: "Reverb Academy",
		title: "Music Classes in Mohali | Reverb Academy",
		description: "Structured guitar, ukulele, piano and violin lessons in Mohali, across Chandigarh Tricity and online."
	},
	twitter: {
		card: "summary",
		title: "Music Classes in Mohali | Reverb Academy",
...
var structuredData = {
	...
	"@graph": [
		...
		{
			"@type": "MusicSchool",
			"@id": `${siteUrl}/#sector-69`,
			name: "Reverb Academy — Sector 69",
			parentOrganization: { "@id": `${siteUrl}/#organization` },
			url: `${siteUrl}/#locations`,
			telephone: "+91-77079-91919",
			address: {
				"@type": "PostalAddress",
				streetAddress: "1st Floor, Sovo International School, Sector 69",
			...
			geo: {
				"@type": "GeoCoordinates",
				latitude: 30.6956682,
				longitude: 76.7217892
			}
		},
		{
			"@type": "MusicSchool",
			"@id": `${siteUrl}/#sector-113`,
			name: "Reverb Academy — Sector 113",
			parentOrganization: { "@id": `${siteUrl}/#organization` },
			url: `${siteUrl}/#locations`,
			telephone: "+91-77079-91919",
			address: {
				"@type": "PostalAddress",
				streetAddress: "45C, 3rd Floor, Bollywood Green City, Sector 113",
		...
		...[
			...
			"@type": "Course",
			"@id": `${siteUrl}/#${instrument.toLowerCase()}-lessons`,
			name: `${instrument} Lessons in Mohali and Online`,
			description: `Structured ${instrument.toLowerCase()} lessons for beginners and developing musicians at Reverb Academy.`,
			provider: { "@id": `${siteUrl}/#organization` },
			educationalLevel: "Beginner to developing musician",
...
var __publicFiles = new Set([
	...
	"/file.svg",
	"/globe.svg",
	"/instrument-guitar.png",
	"/instrument-piano.png",
	"/instrument-ukulele.png",
	"/instrument-violin.png",
	"/llms.txt",
	"/reverb-hero.png",
	"/robots.txt",
	"/sitemap.xml",
